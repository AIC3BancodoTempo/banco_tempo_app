          ...
          child: Stack(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text("Trocar horas de ${widget.nome}",style: TextStyle(color: Colors.white,),),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Expanded(
                      ...
                      SizedBox(width: 5,),
                      Expanded(flex: 1, child: Text("Horas",style: TextStyle(color: Colors.white),textAlign: TextAlign.start,))
                    ],
                  ),
                  Opacity(
