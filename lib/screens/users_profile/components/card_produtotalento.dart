          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(widget.service.quantidade.toString()+" und",style: TextStyle(color: themeColor,fontSize: 15),),
                  Text(widget.service.horas.toString()+" horas",style: TextStyle(color: themeColor,fontSize: 15)),
                ],
              ),
            )
          ],
